...
const useProductStore = create((set)=>({
   products : [
    ...
    },
    {
      ...
      price: 109,
      description:
        "3D NAND flash are applied to deliver high transfer speeds. Remarkable transfer speeds to improve system startup and speedy operational processes.",
      category: "electronics",
      image: "https://fakestoreapi.com/img/71kWymZ+8tL._AC_SX679_.jpg",
      rating: {
        rate: 4.8,
        count: 319,
      },
    ...
    },
    {
      ...
      price: 999.99,
      description:
        "49 INCH SUPER ULTRAWIDE 32:9 CURVED GAMING MONITOR with dual 27 inch screen side by side, QLED technology, HDR support and factory calibration for the most accurate and vivid colors.",
      category: "electronics",
    ...
    },
    {
      ...
      price: 56.99,
      description:
        "Note:The Jackets is in US standard size, so please choose your normal size. Warm and Windproof: 1) Adjustable and detachable hood; 2) Inside windproof snap powder skirt; 3) Adjustable cuffs with hook and loop fastener and stretchable thumb holes; 4) Full zipper closure with a button placket overlay for extra protection.",
    ...
    },
    {
      ...
      price: 29.95,
      description:
        "100% POLYURETHANE (shell) 100% POLYESTER (lining) 75% POLYESTER 25% COTTON (hood) Faux leather material for style and comfort / 2 pockets of front with button closure / Button detail on waist / Detail stitching at sides.",
      category: "women's clothing",
    ...
    },
    {
      ...
      price: 39.99,
      description:
        "Lightweight perfect for trip or casual wear---Long sleeve with hooded, adjustable drawstring waist design. Button and zipper front closure raincoat, fully stripes Lined and Water Resistant.",
      category: "women's clothing",
    ...
    },
    {
      ...
      price: 9.85,
      description:
        "95% RAYON 5% SPANDEX / Jersey fabric, lightweight and comfortable / Ribbed on sleeves and neckline / Double stitching on bottom hem.",
      category: "women's clothing",
    ...
    },
    {
      ...
      price: 7.95,
      description:
        "100% Polyester, Machine wash, 2-button placket for a feminine look and extra comfort. Lightweight and breathable.",
      category: "women's clothing",
