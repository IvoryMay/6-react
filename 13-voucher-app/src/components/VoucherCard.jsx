...
const VoucherCard = () => {
  ...
  const handlePrint = () => {
    printJS({
      printable: "printArea", // ID of the div to print
      type: "html",
      scanStyles: true, // Avoids duplicating Tailwind styles
      css: "https://cdn.jsdelivr.net/npm/tailwindcss@2.2.19/dist/tailwind.min.css", // Inject Tailwind
    });
  };
